...
export const command = "mv <source> <target>";
export const describe = "moves a file or directory to the target path. if the <target> argument is a directory, the source is created as a child of it.";
export const builder = (yargs: yargs.Argv) => {
  return yargs.positional("source", {
    describe: "the file or directory to be moved",
  }).positional("target", {
